...
const Edit = () => {
 ...
 useEffect(() => {
  async function getStudent() {
   try {
    const student = await axios.get(`https://4s4bu8mf1b.execute-api.us-east-1.amazonaws.com/data/students/${id}`)
 ...
 async function onFormSubmit(e) {
  e.preventDefault()
  try {
   await axios.put(`https://4s4bu8mf1b.execute-api.us-east-1.amazonaws.com/data/students/${id}`, student)
   history.push("/")
  } catch (error) {
   console.log("Something is Wrong");
  }
