...
const List = () => {
 ...
 useEffect(() => {
  async function getAllStudent() {
   try {
    const students = await axios.get("https://4s4bu8mf1b.execute-api.us-east-1.amazonaws.com/data/students-data")
 ...
 const handleDelete = async id => {
  await axios.delete(`https://4s4bu8mf1b.execute-api.us-east-1.amazonaws.com/data/students/${id}`);
